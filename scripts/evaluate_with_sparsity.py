...
def main(args):
    ...
    real_data_preprocessed = real_data  # Already preprocessed
    gen_data_preprocessed = gen_data    # Model outputs preprocessed scale
    ...
    # THEN convert back for visualization only
    real_data_for_viz = preprocessor.inverse(real_data_preprocessed)
    gen_data_for_viz = preprocessor.inverse(gen_data_sparse)
